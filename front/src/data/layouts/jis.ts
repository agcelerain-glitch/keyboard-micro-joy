...
const keys: KeyDef[] = [
  // Row 0 — Number row (JIS)
  { code: 'Backquote',   label: '半/全',              row: 0, col: 0,  width: 1,    side: 'left'  },
  ...
  { code: 'Digit0',      label: '0',                 row: 0, col: 10, width: 1,    side: 'right' },
  { code: 'Minus',       label: '-',  label2: '=',   row: 0, col: 11, width: 1,    side: 'right' },
